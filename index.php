...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/main.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <br>
                    <br>
                    <h1>Selamat Datang di Website Coffee Vibes!</h1>
                    <br>
                    <h3 class="font-white space-xs">"Mulailah hari mu dengan kopi" <br> - CoffeeVibes.</h3>
                </div>
            </div>
            <!--end:Hero inner -->
        </section>
        ...
        <section class="popular bg-image" data-image-src="images/img/about.png">
            <div class="container">
                <div class="title text-xs-right m-b-30">
                    <br>
                    <br>
                    <br>
                    <h2 class="text-brown"><b>Kenapa memilih kami?</h2>
                </div>
                <div class="text-xs-right m-b-30">
                    <p class="lead">Coffee Vibes tempat di mana kelezatan dan kesejahteraan 
                        <br>saling berpadu dalam sebuah pengalaman yang tak terlupakan.                         
                        <br>Kami mengundang Anda untuk memasuki dunia kami yang penuh dengan aroma menggoda,                         
                        <br>rasa yang memikat, dan suasana yang menenangkan. Di tengah kehidupan sehari-hari,                         
                        <br>Coffee Vibes menjadi tempat yang sempurna untuk melarikan diri sejenak                         
                        <br>dan menemukan kedamaian yang sejati.
                    </p><br></br>
                    </div>             
                    <div class="text-xs-left col-sm-10 m-b-30">
                        <h3><b>Informasi Coffee Vibes : </b></h3>
                        <p class="lead">
                        &#x1F4CC;  Lokasi : Jl. Wonorejo Selatan 
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2><b>3 Langkah Mudah untuk Pesan</h2>
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Pilih makanan yang ingin dipesan</h3>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4><b>Pilihan Menu CoffeeVibes</h4> </div>
                    </div>
                </div>
                <!-- menu listing starts -->
                <div class="row">
                    <div class="restaurant-listing">
						<?php  //fetching records from table and filter using html data-filter tag
                            $ress= mysqli_query($db,"select * from menu_kategori");  
                            while($rows=mysqli_fetch_array($ress)){	
                                        echo ' <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all '.$rowss['title'].'">
                                        <div class="restaurant-wrap">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                                    <a class="restaurant-logo" href="menu.php?res_id='.$rows['mk_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
                                                </div>
                                                <!--end:col -->
                                                <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                                    <h5><a href="menu.php?res_id='.$rows['mk_id'].'" >'.$rows['title'].'</a></h5> <h6>'.$rows['deskripsi'].'</h6>
                                                    <div class="bottom-part">
                                                    </div>
                                                </div>
                                                <!-- end:col -->
