					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update menu set mk_id='$_POST[res_name]',title='$_POST[d_name]',price='$_POST[price]',img='$fnew' where m_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
												mysqli_query($db, $sql); 
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="btn btn-dsanger btn-circle m-r-10"><i class="fa fa-link"></i></div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated zoomIn" aria-labelledby="2">
                                <ul>
                                    <li>
                                        <div class="drop-title">Anda memiliki 4 pesan yang belum dibaca</div>
                                    </li>
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Update Menu sesuai Kategori Menu</h4>
                            </div>
                            <div class="card-body">
