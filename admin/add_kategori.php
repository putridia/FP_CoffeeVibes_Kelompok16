...
{
	if(empty($_POST['res_name'])||$_POST['deskripsi']=='')
		{	
		    ...
		    {        
                if($fsize>=1000000)
					...
					$error = 	'<div class="alert alert-danger alert-dismissible fade show">
                        ...
                        $sql = "INSERT INTO menu_kategori(title,deskripsi,image) VALUE('".$res_name."','".$_POST['deskripsi']."','".$fnew."')";  // store the submited data ino the database :images
                        mysqli_query($db, $sql); 
                        move_uploaded_file($temp, $store);

                            $success = 	'<div class="alert alert-success alert-dismissible fade show">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <strong>Congrats!</strong> Kategori Menu Baru Berhasil Ditambahkan.
                                    </div>';
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Kategori Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="allkategori.php">All Katergori Menu</a></li>
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Kategori Menu</h3> </div>
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add New Kategori Menu</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" class="form-control" placeholder="Snack">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="deskripsi" class="form-control form-control-danger" placeholder="makanan ini sangat....">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
