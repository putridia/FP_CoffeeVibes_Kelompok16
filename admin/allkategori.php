        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">All Kategori Menu Info</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
						     <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Kategori Menu</h4>								
                                ...
                                <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql="SELECT * FROM menu_kategori order by mk_id desc";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$mql="SELECT * FROM menu_kategori where mk_id='".$rows['mk_id']."'";
																					...
																					echo ' <tr><td>'.$row['title'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 <td><a href="delete_stores.php?res_del='.$rows['mk_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_restraunt.php?res_upd='.$rows['mk_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';
