...
if(isset($_POST['submit'])){        //if upload btn is pressed
	if(empty($_POST['d_name'])||$_POST['price']==''||$_POST['res_name']==''){	
	...
	else
		{
				...
				$store = "Res_img/menu/".basename($fnew);// the path to store the upload image
					...
					{  
                        if($fsize>=1000000){
							...
							$sql = "INSERT INTO menu (mk_id,title,price,img) VALUE('".$res_name."','".$_POST['d_name']."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
							mysqli_query($db, $sql); 
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add New Menu</h3> </div>
                    ...
                    <?php  echo $error;
                            ...
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Add Menu to Kategori Menu</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
											<div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Select Kategori Menu</label>
													<select name="res_name" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
                                                        <option>--Choose the Kategori Menu--</option>
                                                        <?php $ssql ="select * from menu_kategori";
                                                        $res=mysqli_query($db, $ssql); 
                                                        while($row=mysqli_fetch_array($res)){
                                                            echo' <option value="'.$row['mk_id'].'">'.$row['title'].'</option>';;
                                                        }
													?> 
													 </select>
                                                </div>
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                    <?php  echo $error;
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Menu sesuai Kategori Menu</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Nama Menu</label>
                                                    <input type="text" name="d_name" class="form-control" placeholder="Chicken">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <!--/span-->
                                        ...
                                        <div class="row">
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Select Kategori</label>
													<select name="res_name" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
