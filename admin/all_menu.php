...
if (!isset($_SESSION['username'])) {
    // Jika sesi login tidak ada, redirect pengguna ke halaman login
                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <h6 class="card-subtitle">Export data to Excel dan PDF</h6>
                                <button class="btn btn-primary"><a class="text-white" href="pdflaporanmenu.php">Export PDF</a></button> <button class="btn btn-primary"><a class="text-white" href="reportlaporanmenu.php">Export Excel</a></button>
													...
													if(!mysqli_num_rows($query) > 0 )
														...
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				$mql="select * from menu_kategori where mk_id='".$rows['mk_id']."'";
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td>'.$fetch['title'].'</td>
																								...
																								<center><img src="Res_img/menu/'.$rows['img'].'" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																									 ...
																									 <td><a href="delete_menu.php?menu_del='.$rows['m_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_menu.php?menu_upd='.$rows['m_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';
