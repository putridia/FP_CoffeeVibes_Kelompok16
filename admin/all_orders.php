                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated zoomIn">
                                <ul>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="javascript:void(0);"> <strong>Perikasa Semua Notifikasi</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary"><a class="text-white" href="pdflaporanpenjualan.php">Export PDF</a></button> <button class="btn btn-primary"><a class="text-white" href="reportlaporanpenjualan.php">Export Excel</a></button>
