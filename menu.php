...
<body>
        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from menu_kategori where mk_id='$_GET[res_id]'");
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="menu.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["m_id"]; ?>" >
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>Jumlah Total</p>
                                        <h3 class="value"><strong>Rp. <?php echo $item_total; ?></strong></h3>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-9">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                             Menu Kami <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  // display values and item of food/dishes
									$stmt = $db->prepare("select * from menu where mk_id='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='menu.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['m_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/menu/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
